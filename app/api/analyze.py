...
# ==============================================================================
# --- KONFIGURASI & PATH ---
# Vercel menjalankan skrip dari root, jadi path harus relatif dari root
# ==============================================================================
...
# ==============================================================================
# --- DEFINISI MODEL & FUNGSI HELPER (Sama seperti sebelumnya) ---
# ==============================================================================
...
try:
    ...
    # Jika gagal memuat model, set model ke None agar bisa ditangani di endpoint
    model = None
